  ...
  return (
    <AnimatePresence mode="wait">
      <Div
        ...
        className="flex fixed mx-auto z-[500000] items-center justify-between space-x-4 max-w-[1444px] w-full top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] backdrop-blur-md"
      >
